...
//   await SysConfig(key: "publicKeyStr",value: '''-----BEGIN PUBLIC KEY-----
...
// -----END PUBLIC KEY-----''').save();
//   await SysConfig(key: "privateKeyStr",value: '''-----BEGIN PRIVATE KEY-----
...
// jiqWngR+SlSRhak=
// -----END PRIVATE KEY-----''').save();
//
//   var data = await SysConfig().select().where('key="publicKeyStr"').top(1).toSingleOrDefault();
//   print(data.value);
}
